(* Test Plan: - We are automatically testing the functions what_piece,
   side_piece, and move, thus implicitly testing board_of_pieces, matching, and
   many helper functions from Board.ml that describe the moves of each chess
   piece. These tests were done through black box and glass box testing. - We
   are manually testing print_board through the interactive game on the
   terminal. - We have proven the correctness of our system by comparing the
   output of our functions with the expected outputs, as well as physically
   seeing if our system works the way it is supposed through our interactive
   terminal.*)
open OUnit2
open Game
open Board
...
let en_passant_test (name : string) (board : board) (orow : int) (ocol : int)
    (drow : int) (dcol : int) (expected_output : bool) : test =
  name >:: fun _ ->
  assert_equal expected_output (en_passant board orow ocol drow dcol)
...
let side_piece_tests =
  [
    ...
    side_piece_test "side piece nothing" "_" "none";
  ]
  ...
  [
    ...
    reset
      (move_piece_test "move white pawn 63 to 43 (d2 to d4)" board_of_pieces 6 3
         4 3);
    move_piece_test "move black pawn 11 to 31 (b7 to b5) " board_of_pieces 1 1 3
      1;
  ...
  [
    ...
    reset
      (move_legal_test "move white pawn 2 one space legal" board_of_pieces 6 2 5
         2 true);
    move_legal_test "move white pawn 3 one space legal" board_of_pieces 6 3 5 3
      true;
    reset
    ...
    reset
      (move_legal_test "move white pawn 7 one space legal" board_of_pieces 6 7 5
         7 true);
    reset
      (move_legal_test "move white pawn 0 two spaces legal" board_of_pieces 6 0
         4 0 true);
    reset
      (move_legal_test "move white pawn 1 two spaces legal" board_of_pieces 6 1
         4 1 true);
    reset
      (move_legal_test "move white pawn 2 two spaces legal" board_of_pieces 6 2
         4 2 true);
    reset
      (move_legal_test "move white pawn 3 two spaces legal" board_of_pieces 6 3
         4 3 true);
    reset
      (move_legal_test "move white pawn 4 two spaces legal" board_of_pieces 6 4
         4 4 true);
    reset
      (move_legal_test "move white pawn 5 two spaces legal" board_of_pieces 6 5
         4 5 true);
    reset
      (move_legal_test "move white pawn 6 two spaces legal" board_of_pieces 6 6
         4 6 true);
    reset
      (move_legal_test "move white pawn 7 two spaces legal" board_of_pieces 6 7
         4 7 true);
    reset
    ...
    reset
      (move_legal_test "move white knight illegal" board_of_pieces 7 1 7 0 false);
    ...
    move_legal_test "move white rook legal" board_of_pieces 7 0 6 0 true;
    move_legal_test "move white rook legal" board_of_pieces 6 0 7 0 true;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 7 1 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 7 2 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 7 3 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 7 4 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 7 5 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 7 6 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 7 7 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 6 1 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 6 2 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 6 3 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 6 4 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 6 5 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 6 6 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 6 7 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 5 0 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 5 1 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 5 2 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 5 3 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 5 4 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 5 5 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 5 6 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 5 7 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 4 0 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 4 1 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 4 2 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 4 3 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 4 4 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 4 5 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 4 6 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 4 7 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 3 0 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 3 1 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 3 2 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 3 3 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 3 4 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 3 5 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 3 6 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 3 7 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 2 0 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 2 1 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 2 2 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 2 3 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 2 4 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 2 5 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 2 6 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 2 7 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 1 0 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 1 1 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 1 2 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 1 3 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 1 4 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 1 5 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 1 6 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 1 7 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 0 0 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 0 1 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 0 2 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 0 3 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 0 4 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 0 5 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 0 6 false;
    move_legal_test "move white rook illegal" board_of_pieces 7 0 0 7 false;
    move_legal_test "move white bishop legal" board_of_pieces 7 3 6 3 true;
    move_legal_test "move white bishop legal" board_of_pieces 6 3 5 4 true;
    move_legal_test "move white bishop legal" board_of_pieces 5 4 4 5 true;
    move_legal_test "move white bishop legal" board_of_pieces 4 5 3 6 true;
    move_legal_test "move white bishop legal" board_of_pieces 3 6 2 7 true;
    move_legal_test "move white bishop legal" board_of_pieces 2 7 3 6 true;
    move_legal_test "move white bishop legal" board_of_pieces 3 6 4 5 true;
    move_legal_test "move white bishop legal" board_of_pieces 4 5 5 4 true;
    move_legal_test "move white bishop legal" board_of_pieces 5 4 6 3 true;
    move_legal_test "move white bishop legal" board_of_pieces 6 3 7 2 true;
    move_legal_test "move white bishop legal" board_of_pieces 7 2 2 7 true;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 7 0 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 7 1 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 7 3 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 7 4 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 7 5 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 7 6 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 7 7 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 6 0 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 6 1 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 6 2 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 6 4 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 6 5 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 6 6 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 6 7 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 5 0 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 5 1 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 5 2 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 5 3 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 5 5 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 5 6 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 5 7 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 4 0 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 4 1 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 4 2 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 4 3 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 4 4 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 4 6 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 4 7 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 3 0 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 3 1 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 3 2 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 3 3 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 3 4 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 3 5 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 3 7 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 2 0 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 2 1 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 2 2 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 2 3 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 2 4 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 2 5 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 2 6 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 1 0 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 1 1 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 1 2 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 1 3 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 1 4 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 1 5 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 1 6 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 1 7 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 0 0 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 0 1 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 0 2 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 0 3 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 0 4 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 0 5 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 0 6 false;
    move_legal_test "move white bishop illegal" board_of_pieces 2 7 0 7 false;
    move_legal_test "move white knight illegal" board_of_pieces 7 1 7 0 false;
    move_legal_test "move white knight illegal" board_of_pieces 7 1 7 1 false;
    move_legal_test "move white knight illegal" board_of_pieces 7 1 7 2 false;
    move_legal_test "move white knight illegal" board_of_pieces 7 1 7 3 false;
    move_legal_test "move white knight illegal" board_of_pieces 7 1 7 4 false;
    move_legal_test "move white knight illegal" board_of_pieces 7 1 7 5 false;
    ...
    (*possibly an error*)
    move_legal_test "move black bishop legal" board_of_pieces 0 2 1 3 true;
    move_legal_test "double move black pawn" board_of_pieces 1 3 3 3 true;
    move_legal_test "move the pawn one more space" board_of_pieces 3 3 4 3 true;
    ...
    move_legal_test "move black knight right illegal 2" board_of_pieces 1 4 3 5
      false;
    move_legal_test "move black knight right legal 3" board_of_pieces 1 4 3 3
      true;
